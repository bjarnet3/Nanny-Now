...
class FamilyPageOne: UIViewController {
...
extension FamilyPageOne {
    ...
    private func performAnimation() {
        ...
        if advertiseViewHidden {
            ...
            UIView.animate(withDuration: 0.90, delay: 0.034, usingSpringWithDamping: 0.50, initialSpringVelocity: 0.34, options: .curveEaseOut, animations: {
                self.postAnimation()
            })
