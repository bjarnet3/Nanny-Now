...
class LoginPageVC: UIPageViewController {
    ...
    override func viewDidLoad() {
        ...
        let page0 = storyboard!.instantiateViewController(withIdentifier: "LoginZero") as? LoginZeroVC
        let page1 = storyboard!.instantiateViewController(withIdentifier: "LoginOne") as? LoginOneVC
        let page2 = storyboard!.instantiateViewController(withIdentifier: "LoginTwo") as? LoginTwoVC
        // let page2: UIViewController! = storyboard!.instantiateViewController(withIdentifier: "LoginTwo")
...
extension LoginPageVC : UIPageViewControllerDataSource, UIPageViewControllerDelegate {
