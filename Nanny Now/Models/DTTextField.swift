...
//  Nanny Now
//
//  Created by Bjarne Tvedten on 28.10.2017.
...
public class DTTextField: UITextField {
    ...
    fileprivate let paddingX:CGFloat                        = 22.0
    fileprivate let paddingHeight:CGFloat                   = 4.0
    
    public var dtLayer:CALayer                              = CALayer()
    public var floatPlaceholderColor:UIColor                = UIColor.black
    public var floatPlaceholderActiveColor:UIColor          = UIColor.purple
    ...
    fileprivate func commonInit() {
        ...
        dtLayer.cornerRadius        = self.frame.height / 2
        ...
        floatPlaceholderActiveColor = .purple
