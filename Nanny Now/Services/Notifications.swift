...
/* Testing av Notifications med Curl in Terminal
 ...
 curl -H "Content-type: application/json" -H "Authorization:key=AAAAd-nNctg:APA91bGhfGrYaRg-QOHx0LlfTyqU9cwOECMvm6jGHMZaeLGsToNPJtgV0y-EfcmMVFZbfbxdkF3ubJ8NC94-B-I74lV-UG2f-kuvjLtOnG_wbHecjdBc93Y59tv7XCJCEXEW3hTKH4oC"  -X POST -d '{ "data": { "category": "messageRequest","mediaUrl": "https://graph.facebook.com/10157516443970641/picture?type=large"},"registration_ids" : ["d6mbh-Ka04Q:APA91bEOzMU99eONJDqZiDzZn0DaL-87YHtgTglu4GfuSOFdCTVZz5WQ2ImTi-UmaqgDICFDeMSbFege2KWjQbdNLIt0lY8LIqZrMC5h2w0tnLc6be9bpXCXeD4IKJkpAboXAnIocoFf"],"notification":{"title":"Bjarne Tvedten","body":"Nanny Now - Please","sound":"default","badge":1},"priority":10, "content_available": true, "mutable_content": true }' https://fcm.googleapis.com/fcm/send
 */
